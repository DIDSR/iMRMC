...
These data frames (printed below as *Table 2* and *Table 3*, respectively) each provide 3 rows. The first two rows correspond to the single-modality variance of each modality and the covariance of the difference between the two modalities. Values in these tables have been rounded for conciseness. 
