...
clear all
close all
[num,txt,raw] = xlsread('splitPlotMCmean.xlsx','sheet1');
plotcolor = {'r','b','k'};
plotsign = {'o','*','s'};
plotlegend = {};
...
BDGcol = strmatch('rejectBDG',txt(1,:),'exact');
realAUClist= [0.65,0.8,0.9];
colorlist = {'r','g','b'};
signlist = {'o','+','s'};
...
text (12.5,-0.035, 'Simulation Configuration','Horizontalalignment','Center','FontSize',16);
subplot(3,1,1);
%title('BDG Model Observed Type 1 Error Rates','FontSize',16);
     dim = [.45 .8 .3 .1];
     str = ['AUC_1 = AUC_2 = ', num2str(realAUClist(1))];
     annotation('textbox',dim,'String',str,'FitBoxToText','on','FontSize',12);
     
     dim = [.45 .5 .3 .1];
     str = ['AUC_1 = AUC_2 = ', num2str(realAUClist(2))];
     annotation('textbox',dim,'String',str,'FitBoxToText','on','FontSize',12);
     
     dim = [.45 .2 .3 .1];
     str = ['AUC_1 = AUC_2 = ', num2str(realAUClist(3))];
     annotation('textbox',dim,'String',str,'FitBoxToText','on','FontSize',12);
