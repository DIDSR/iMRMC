...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Title","1. Introduction","2. Getting Started","3. Run iRoeMetz","4. Input and Output Files","5. Method","Reference","GUI interface","Command line","Input File","Output File","Study Design","Roe & Metz Model","Simulation Results: MC means window","Numerical Integration Results window"],
    DREX_NODE_LINKS: ["index.htm","introduction.htm","getting_started.htm","run_iroemetz.htm","4__input_and_output_files.htm","5__method.htm","reference.htm","gui_interface.htm","command_line.htm","input_file.htm","output_file.htm","study_design.htm","roe___metz_model.htm","simulation_results__mc_means_window.htm","numerical_integration_results_window.htm"],
    DREX_NODE_CHILD_START: [1,7,7,7,9,11,13,13,15,15,15,15,15,15,15],
    DREX_NODE_CHILD_END: [7,7,7,9,11,13,13,15,15,15,15,15,15,15,15],
    DREX_MENU_TYPE: 1,
